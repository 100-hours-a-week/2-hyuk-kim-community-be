...
// userRoute.patch("/users/profile", upload.single('image'), validateMiddleware(userSchema.updateProfile), userController.updateProfile); // O
userRoute.patch("/users/profile", validateMiddleware(userSchema.updateProfile), userController.updateProfile); // O
